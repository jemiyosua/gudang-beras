...
if (isset($_GET['search_history'])) {
    ...
    if ($cari == "") {
        $q = "SELECT COUNT(1) AS CNT FROM db_log_history WHERE kategori = 'HUUT'";
        $sql = mysqli_query($conn, $q);
    } else {
        $q = "SELECT COUNT(1) AS CNT FROM db_log_history WHERE kategori = 'HUUT' AND jenis LIKE '%" . $cari . "%'";
        $sql = mysqli_query($conn, $q);
    }
} else {
    $q = "SELECT COUNT(1) AS CNT FROM db_log_history WHERE kategori = 'HUUT'";
...
<main id="main" class="main">
	...
	<div class="pagetitle">
        ...
        <nav>
            ...
            <li class="breadcrumb-item active">Master Huut</li>
            </ol>
        </nav>
	</div>
							...
							<div class="card-body">
                                ...
                                if ($_SESSION['role'] == "admin") {
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="input-master-huut.php" type="button" class="btn btn-primary"><i class="bi bi-plus-circle-fill"></i> Tambah Stok Huut</a>
                                    </div>
                                    <?php
                                }
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <h5 class="card-title">List Master Huut</h5>
                                </div>
                                ...
                                <table class="table mt-3">
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($_GET['search_history'])) {
                                            ...
                                            if ($Search == "") {
                                                $q = "SELECT * FROM db_huut ORDER BY tgl_input DESC LIMIT $limit_start, $limit";
                                            } else {
                                                $q = "SELECT * FROM db_huut WHERE jenis LIKE '%" . $Search . "%' ORDER BY tgl_input DESC LIMIT $limit_start, $limit";
                                            }
                                        } else {
                                            $q = "SELECT * FROM db_huut ORDER BY tgl_input DESC LIMIT $limit_start, $limit";
                                        }
                                        ...
                                        if ($jumlah > 0) {
                                            while ($row = mysqli_fetch_assoc($sql)) {
                                                ...
                                                <tr>
                                                    <th scope="row"><?= $No; ?></th>
                                                    <td style="font-weight:bold"><?= $BeratHuut . " " . $KeteranganHabis ?></td>
                                                    <td style="color:<?= $ColorText ?>"><?= $KarungHuut ?></td>
                                                    <td>Rp <?= number_format($HargaHuut) ?></td>
                                                    <?php
                                                    
                                                    if ($_SESSION['role'] == "admin") {
                                                        ?>
                                                        <td colspan=2>
                                                            <a href="update-master-huut.php?id=<?= $Id ?>"><span class="badge rounded-pill text-bg-info">Edit Data</span></a>
                                                            <a href="proses.php?function=delete-master-huut&id=<?= $Id ?>" onclick="return checkDelete()"><span class="badge rounded-pill text-bg-danger">Delete Data</span></a>
                                                        </td>
                                                        <?php
                                                    }
                            ...
                            <nav aria-label="Page navigation example" style="padding-top: 10px;padding-left: 15px">
                                <ul class="pagination">
                                    ...
                                    if ($page == 1) { // Jika page adalah page ke 1, maka disable link PREV
                                        ...
                                        echo "<li class='page-item'><a class='page-link' href='list-huut.php?page=1'>First</a></li>";
                                        echo "<li class='page-item'><a class='page-link' href='list-huut.php?page=$link_prev'>&laquo;</a></li>";
                                    }
                                    ...
                                    if (isset($_GET['search'])) {
                                        ...
                                        if ($cari == "") {
                                            ...
                                            $q = "SELECT COUNT(1) AS CNT FROM db_huut WHERE jenis LIKE '%" . $cari . "%'";
                                            $sql = mysqli_query($conn, $q);
                                        }
                                    } else {
                                        $q = "SELECT COUNT(1) AS CNT FROM db_huut";
                                    ...
                                    for ($i = $start_number; $i <= $end_number; $i++) {
                                        ...
                                        if (isset($_GET['search'])) {
                                            $cari = $_GET['search'];
                                            if ($cari != "") {
                                                echo "<li$link_active><a class='page-link' href='list-huut.php?page=$i&search=$cari'>$i</a></li>";
                                            } else {
                                                echo "<li$link_active><a class='page-link' href='list-huut.php?page=$i'>$i</a></li>";
                                            }
                                        } else {
                                            echo "<li$link_active><a class='page-link' href='list-huut.php?page=$i'>$i</a></li>";
                                        }
                                    ...
                                    if ($page == $jumlah_page) { // Jika page terakhir
                                        ...
                                        echo "<li class='page-item'><a class='page-link' href='list-huut.php?page=$link_next'>&raquo;</a></li>";
                                        echo "<li class='page-item'><a class='page-link' href='list-huut.php?page=$jumlah_page'>Last</a></li>";
                                    }
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <h5 class="card-title">History Master Huut</h5>
                            <!-- <div class="mt-4">
                        ...
                        <table class="table mt-3">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['search_history'])) {
                                    ...
                                    if ($Search == "") {
                                        $q = "SELECT * FROM db_log_history WHERE kategori = 'HUUT' ORDER BY tgl_input DESC LIMIT $limit_start, $limit";
                                    } else {
                                        $q = "SELECT * FROM db_log_history WHERE kategori = 'HUUT' AND jenis LIKE '%" . $Search . "%' ORDER BY tgl_input DESC LIMIT $limit_start, $limit";
                                    }
                                } else {
                                    $q = "SELECT * FROM db_log_history WHERE kategori = 'HUUT' ORDER BY tgl_input DESC LIMIT $limit_start, $limit";
                                }
                        ...
                        <ul class="pagination">
                            ...
                            for ($i = $start_number; $i <= $end_number; $i++) {
                                ...
                                if (isset($_GET['search_history'])) {
                                    $cari = $_GET['search_history'];
                                    if ($cari != "") {
                                        echo "<li$link_active><a class='page-link' href='list-huut.php?page=$i&search_history=$cari'>$i</a></li>";
                                    } else {
                                        echo "<li$link_active><a class='page-link' href='list-huut.php?page=$i'>$i</a></li>";
                                    }
                                } else {
